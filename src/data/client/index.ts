...
class Client {
  ...
  users = {
    ...
    otpLogin: (input: { otp_id: string; code: string; phone_number: string; name?: string; email?: string; permission?: string; accept_terms?: boolean; accept_privacy?: boolean; marketing_email_consent?: boolean; marketing_push_consent?: boolean }) =>
