export const API_ENDPOINTS = {
  ...
  TOP_SHOPS: '/top-shops',
  ORDERS: '/orders',
  ORDERS_CREATE_DIGITAL: '/orders/create',
  ...
  PAYMENTS_YOOKASSA_CONFIRM: '/payments/yookassa/confirm',
  GENERATE_DOWNLOADABLE_PRODUCT_LINK: '/downloads/digital-file',
  PRODUCTS_DOWNLOAD_PROTECTED: '/products/{id}/download',
  PRODUCTS_ACCESS: '/products/{id}/access',
  USERS: '/users',
  USERS_ME: '/me',
  USERS_LOGIN: '/token',
  ...
  PLACES: '/places',
  PLACES_FEED: '/places/feed', // Cursor-based infinite scroll feed
  PLACES_SIMILAR: '/places/{id}/similar', // Similar places
  MY_PLACES: '/my-places',
