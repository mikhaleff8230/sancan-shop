...
const colorNameToHex: Record<string, string> = {
  ...
  'голубой': '#00BFFF',
  'cyan': '#00BFFF',
  'темно-зеленый': 'var(--color-accent)',
  'dark green': 'var(--color-accent)',
  'светло-зеленый': 'var(--color-accent)',
  'light green': 'var(--color-accent)',
  'салатовый': 'var(--color-accent)',
  ...
  'хаки': '#C3B091',
  'khaki': '#C3B091',
  'оливковый': 'var(--color-accent)',
  'olive': 'var(--color-accent)',
  'бирюзовый': '#40E0D0',
  'turquoise': '#40E0D0',
  'лавандовый': '#E6E6FA',
  'lavender': '#E6E6FA',
  'мятный': 'var(--color-accent)',
  ...
  'фуксия': '#FF00FF',
  'fuchsia': '#FF00FF',
  'лайм': 'var(--color-accent)',
  'lime green': 'var(--color-accent)',
