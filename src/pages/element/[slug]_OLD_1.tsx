        ...
        <div className="h-full min-h-screen p-4 md:px-6 lg:px-8 lg:pt-6">
          ...
          >
              ...
              <div className="bg-light-100 dark:bg-dark-200 p-6 rounded-lg">
                ...
                {ratings > 0 && (
                  <div className="flex items-center mb-4">
                    ...
                    <span className="ml-1 font-medium">{ratings.toFixed(1)}</span>
                    <span className="mx-2">•</span>
                    <span className="text-gray-600 dark:text-gray-400">
                      {total_reviews} {t('text-reviews')}
                    </span>
                  </div>
                )}
            ...
            >
              ...
              {/* Кнопки действий */}
              <div className="bg-light-100 dark:bg-dark-200 p-6 rounded-lg space-y-4">
                <button className="w-full rounded-lg bg-blue-600 py-3 font-medium text-white hover:bg-blue-700 transition">
                  {t('text-add-to-cart')}
                </button>
                <button className="w-full rounded-lg border border-gray-300 dark:border-gray-600 py-3 font-medium text-dark dark:text-light hover:bg-gray-50 dark:hover:bg-gray-800 transition">
