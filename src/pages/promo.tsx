    ...
    <>
      ...
      <main className="promo-page">
        <header className="promo-header">
          <a href="https://sancan.ru" className="promo-logo" aria-label="SANCAN"><Image src="/promo/sancan-logo.png" alt="SANCAN" width={202} height={28} priority /></a>
        ...
        <footer><a href="https://sancan.ru" className="promo-logo promo-logo-footer"><Image src="/promo/sancan-logo.png" alt="SANCAN" width={202} height={28} /></a><p>Маркетплейс авторских товаров и независимых брендов.</p><a href={SELLER_LOGIN}>Кабинет продавца</a></footer>
        <div className="mobile-sticky"><SignupLink>Создать магазин</SignupLink></div>
      </main>
      <style jsx global>{`
        @font-face{font-family:'Onest';src:url('/promo/onest-cyrillic.woff2') format('woff2');font-style:normal;font-weight:100 900;font-display:swap;unicode-range:U+0301,U+0400-045F,U+0490-0491,U+04B0-04B1,U+2116}
        @font-face{font-family:'Onest';src:url('/promo/onest-latin.woff2') format('woff2');font-style:normal;font-weight:100 900;font-display:swap;unicode-range:U+0000-00FF,U+0131,U+0152-0153,U+02BB-02BC,U+02C6,U+02DA,U+02DC,U+0304,U+0308,U+0329,U+2000-206F,U+20AC,U+2122,U+2191,U+2193,U+2212,U+2215,U+FEFF,U+FFFD}
        :root{--pv:#6d38e0;--pvd:#321374;--ink:#17131f;--cream:#f7f4ef;--lilac:#eee8ff;--line:#ded8e5}
        .promo-page{background:var(--cream);color:var(--ink);font-family:'Onest',Arial,sans-serif;font-weight:400;font-feature-settings:'kern';-webkit-font-smoothing:antialiased;overflow:hidden}.promo-page *{box-sizing:border-box}.promo-page em,.promo-page i{font-style:normal}.promo-header{height:82px;max-width:1440px;margin:auto;padding:0 5vw;display:flex;align-items:center;justify-content:space-between}.promo-logo{display:block;width:202px;line-height:0}.promo-logo img{width:100%;height:auto}.promo-logo-footer{width:150px;background:#fff;border-radius:12px;padding:10px 14px}.promo-header nav{display:flex;gap:34px;font-size:14px;font-weight:500}.promo-header a{color:inherit}.promo-login{padding:12px 20px;border:1px solid #bbb2c5;border-radius:99px;font-size:14px;font-weight:600}.hero{min-height:720px;max-width:1440px;margin:auto;padding:42px 5vw 90px;display:grid;grid-template-columns:.92fr 1.08fr;align-items:center;gap:4vw}.hero-copy{position:relative;z-index:2}.eyebrow,.kicker{display:inline-flex;align-items:center;gap:7px;color:var(--pv);text-transform:uppercase;letter-spacing:.1em;font-size:12px;font-weight:700}.hero h1{font-size:clamp(52px,5.25vw,80px);font-weight:700;line-height:1.01;letter-spacing:-.045em;margin:23px 0}.hero h1 em,.section-heading h2 i,.custom h2 i,.final-cta h2 i{font-family:inherit;font-style:normal;font-weight:700;color:var(--pv)}.hero-lead{font-size:19px;font-weight:400;line-height:1.5;max-width:570px;color:#5d5664}.hero-actions{display:flex;align-items:center;gap:24px;margin:32px 0}.promo-button{display:inline-flex;align-items:center;justify-content:center;gap:10px;background:var(--pv);color:#fff!important;border-radius:99px;padding:16px 24px;font-size:15px;font-weight:700;box-shadow:0 12px 30px #6d38e033;transition:.25s}.promo-button:hover{transform:translateY(-2px);background:#5b27cf}.text-link{display:flex;align-items:center;font-size:14px;font-weight:600}.hero-facts{display:flex;gap:20px;padding-top:20px;border-top:1px solid var(--line)}.hero-facts span{font-size:12px;color:#716979}.hero-facts b{display:block;font-size:20px;font-weight:700;color:var(--ink)}.early-note{display:flex;align-items:center;gap:9px;font-size:13px;margin-top:25px}.early-note span{width:8px;height:8px;border-radius:50%;background:#71c98b;box-shadow:0 0 0 5px #71c98b22}.hero-visual{position:relative;height:610px}.hero-image{position:absolute;inset:20px 0 20px 45px;border-radius:190px 28px 150px 28px;overflow:hidden;box-shadow:0 35px 90px #2f17422b}.hero-image img{object-fit:cover}.hero-visual:before{content:'';position:absolute;width:70%;height:70%;right:-10%;top:-4%;background:#9d75ff55;filter:blur(80px);border-radius:50%}.float-card{position:absolute;background:#fff;padding:17px;border-radius:18px;box-shadow:0 18px 50px #25133126;display:flex;align-items:center;gap:11px;z-index:2}.float-zero{left:0;top:90px}.float-zero b{font-size:32px;font-weight:750;color:var(--pv)}.float-zero span,.float-boost span{font-size:11px;line-height:1.35}.float-boost{right:-5px;bottom:90px}.float-boost svg{color:var(--pv)}.shop-chip{position:absolute;left:20%;bottom:8px;background:#19141f;color:#fff;border-radius:99px;padding:12px 16px;display:flex;gap:8px;align-items:center;font-size:12px}.shop-chip svg:last-child{color:#bba4ff}.promo-section{padding:110px max(5vw,calc((100vw - 1300px)/2))}.section-heading{max-width:540px}.section-heading.centered{text-align:center;margin:0 auto 50px}.section-heading h2,.conversation h2,.boost h2,.benefit-lead h2,.custom h2,.capabilities h2,.early h2{font-size:clamp(42px,4.15vw,60px);font-weight:700;line-height:1.06;letter-spacing:-.038em;margin:16px 0}.section-heading p,.conversation-copy>p,.boost-copy>p,.custom p,.early p{color:#6b6371;line-height:1.55;font-size:17px}.audience{display:grid;grid-template-columns:.72fr 1.28fr;gap:7vw}.audience-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px}.audience-card{background:#fff;border:1px solid #e9e4ec;border-radius:24px;padding:23px;display:flex;gap:15px;transition:.25s}.audience-card:hover{transform:translateY(-4px);box-shadow:0 18px 45px #32137412}.audience-card svg{color:var(--pv);flex:none}.audience-card h3{font-size:18px;font-weight:650;line-height:1.25;margin:0 0 8px}.audience-card p{font-size:14px;color:#716979;line-height:1.45;margin:0}.audience-card.c1,.audience-card.c4{background:var(--lilac)}.benefits{background:var(--pvd);color:#fff;display:grid;grid-template-columns:.8fr 1.2fr;gap:7vw}.kicker.light{color:#cbbcff}.benefit-lead>p{color:#c7bdd5}.big-zero{margin-top:55px;display:flex;align-items:end;gap:18px}.big-zero strong{font-size:88px;font-weight:750;line-height:.8;color:#b9ff8c;letter-spacing:-.055em}.big-zero span{font-size:13px;color:#d5cce2}.feature-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.feature-grid article{padding:26px;border:1px solid #ffffff20;border-radius:25px;background:#ffffff0a}.feature-grid article:first-child{grid-column:span 2;background:#fff;color:var(--ink)}.feature-grid svg{color:#b9ff8c}.feature-grid article:first-child svg{color:var(--pv)}.feature-grid h3{font-size:19px;font-weight:650;line-height:1.25;margin:25px 0 8px}.feature-grid p{font-size:14px;line-height:1.5;color:#cfc5dc}.feature-grid article:first-child p{color:#716979}.payment-grid{display:grid;grid-template-columns:1fr 1fr;gap:20px}.pay-card{border-radius:32px;padding:36px;border:1px solid var(--line);background:#fff}.pay-card.sbp{background:#eaffde;border-color:#c9eeba}.pay-card.safe{background:#eee8ff;border-color:#dbceff}.pay-top{display:flex;justify-content:space-between;align-items:start}.pay-label{font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.08em}.pay-top b{font-size:38px;font-weight:750;color:var(--pv)}.pay-card h3{font-size:28px;font-weight:700;letter-spacing:-.025em;margin:30px 0 8px}.pay-card>p{color:#665e6d;font-size:15px;line-height:1.55;min-height:76px}.flow{display:flex;align-items:center;justify-content:space-between;margin:30px 0;padding:20px;background:#ffffffb5;border-radius:20px}.flow span{display:flex;flex-direction:column;align-items:center;gap:7px;font-size:11px;font-weight:650}.flow svg{width:20px}.flow i svg{width:16px;color:#91879b}.sbp-dot{background:linear-gradient(135deg,#08b9ce,#6c3be1);color:#fff;padding:14px;border-radius:50%}.brand-dot{color:var(--pv)}.pay-card small{display:flex;gap:7px;align-items:center;font-weight:600}.pay-card small svg{width:17px}.compare{display:grid;grid-template-columns:1.3fr 1fr 1fr;margin-top:24px;background:#fff;border-radius:25px;padding:10px 28px}.compare>*{padding:15px;border-bottom:1px solid #eee8f0}.compare>*:nth-last-child(-n+3){border:0}.compare b{font-weight:650;color:var(--pv)}.compare strong{font-size:14px;font-weight:650}.compare span{color:#746b7a;font-size:13px}.boost{background:#19141f;color:#fff;display:grid;grid-template-columns:.85fr 1.15fr;gap:7vw;align-items:center}.boost-copy>p{color:#c4bbc9}.boost-copy ul{display:grid;grid-template-columns:1fr 1fr;gap:14px;padding:0;margin:30px 0;list-style:none}.boost-copy li{display:flex;align-items:center;gap:8px;font-size:14px}.boost-copy li svg{width:17px;color:#b9ff8c}.boost-ui{background:#f7f4f9;color:var(--ink);border-radius:32px;padding:26px;box-shadow:0 35px 90px #0008;transform:rotate(1deg)}.product-row{display:flex;gap:16px;align-items:center}.product-art{width:105px;height:115px;border-radius:20px;background:linear-gradient(140deg,#d7c6aa,#f2e9dc);display:flex;align-items:center;justify-content:center;text-align:center;font-family:inherit;font-weight:600;color:#765c43}.product-row small,.switch-row small{display:block;color:#8a8190}.product-row h3{font-weight:650;margin:6px 0}.switch-row{display:flex;justify-content:space-between;margin:22px 0;padding:18px 0;border-top:1px solid #ddd6e0;border-bottom:1px solid #ddd6e0}.switch{width:51px;height:29px;border-radius:99px;background:var(--pv);padding:4px}.switch i{display:block;width:21px;height:21px;background:#fff;border-radius:50%;margin-left:auto}.intensity>span{font-size:12px;font-weight:650}.range{height:5px;background:#d8cfe1;border-radius:9px;margin:20px 5px 12px}.range i{display:block;width:42%;height:100%;background:var(--pv);position:relative}.range i:after{content:'';position:absolute;right:-7px;top:-5px;width:15px;height:15px;border-radius:50%;background:var(--pv);box-shadow:0 0 0 5px #6d38e022}.range-values{display:flex;justify-content:space-between;font-size:10px}.range-values b{color:var(--pv)}.stats{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:25px}.stats article{background:#fff;padding:16px;border-radius:18px;display:flex;gap:12px}.stats svg{color:var(--pv)}.stats span{font-size:11px;color:#817889}.stats b{display:block;font-size:22px;font-weight:700;color:var(--ink)}.boost-flow{display:flex;align-items:center;justify-content:center;gap:8px;font-size:10px;margin-top:20px}.boost-flow svg{width:12px}.boost-flow b{background:var(--pv);color:#fff;padding:7px 10px;border-radius:99px}.boost-flow strong{color:var(--pv)}.conversation{display:grid;grid-template-columns:1fr 1fr;gap:9vw;align-items:center}.chat-ui{background:#eee8ff;border-radius:40px;padding:30px;min-height:470px;box-shadow:inset 0 0 0 1px #ded2ff}.chat-head{display:flex;align-items:center;gap:12px;border-bottom:1px solid #d8ccef;padding-bottom:18px}.avatar{width:43px;height:43px;display:grid;place-items:center;background:var(--pv);color:#fff;border-radius:50%;font-weight:700}.chat-head small{display:block;color:#786e83}.online{margin-left:auto;width:9px;height:9px;border-radius:50%;background:#62c883}.bubble{max-width:76%;padding:15px 18px;border-radius:19px;margin-top:35px;font-size:14px}.bubble.buyer{background:#fff;border-bottom-left-radius:5px}.bubble.seller{margin-left:auto;background:var(--pv);color:#fff;border-bottom-right-radius:5px}.chat-input{margin-top:45px;background:#fff;border-radius:99px;color:#98909f;padding:15px 18px;display:flex;justify-content:space-between}.chat-input svg{background:var(--ink);color:#fff;border-radius:50%;padding:5px;width:25px;height:25px}.mini-points{display:flex;gap:25px;margin-top:30px}.mini-points span{display:flex;align-items:center;gap:8px;font-size:14px;font-weight:600}.mini-points svg{color:var(--pv)}.custom{background:#7b48e8;color:#fff;display:grid;grid-template-columns:.8fr 1.2fr;align-items:center;gap:8vw}.custom p{color:#e6ddff}.custom h2 i{color:#c9ff99}.custom-cloud{position:relative;min-height:400px}.tag{position:absolute;background:#fff;color:var(--ink);padding:14px 19px;border-radius:99px;font-weight:600;box-shadow:0 12px 30px #32137440}.t0{left:2%;top:10%}.t1{left:44%;top:2%}.t2{right:2%;top:23%}.t3{left:23%;top:35%;font-size:22px}.t4{left:3%;bottom:28%}.t5{right:18%;bottom:30%}.t6{left:36%;bottom:5%}.t7{right:0;bottom:2%}.t8{left:55%;top:57%;background:#c9ff99}.start .section-heading{max-width:680px}.timeline{display:grid;grid-template-columns:repeat(4,1fr);margin-top:60px;border-top:1px solid #cbc3d0}.timeline article{padding:28px 25px;border-left:1px solid #cbc3d0;display:flex;gap:17px}.timeline article:first-child{border-left:0}.timeline article>b{font-size:13px;font-weight:700;color:var(--pv)}.timeline h3{font-size:18px;font-weight:650;margin:0 0 7px}.timeline p{font-size:13px;color:#776e7c}.start-more{margin-top:25px;background:#fff;border-radius:18px;padding:18px;display:flex;align-items:center;gap:13px;max-width:420px}.start-more svg{color:var(--pv)}.capabilities{background:#21192b;color:#fff;display:grid;grid-template-columns:.8fr 1.2fr;gap:8vw}.cap-list div{display:flex;justify-content:space-between;padding:17px 0;border-bottom:1px solid #ffffff1f}.cap-list b{display:flex;align-items:center;gap:8px;color:#c9ff99;font-size:13px;font-weight:650}.cap-list svg{width:16px}.early{display:grid;grid-template-columns:.65fr 1.35fr;gap:7vw;align-items:center}.early>div:last-child{max-width:750px}.early-orbit{height:360px;position:relative;border:1px solid #c9bddb;border-radius:50%;display:grid;place-items:center}.early-orbit:before,.early-orbit:after{content:'';position:absolute;border:1px solid #d9cfdf;border-radius:50%;inset:16%;transform:rotate(35deg)}.early-orbit:after{inset:33%;background:var(--pv);border:0}.early-orbit svg{position:relative;z-index:2;color:#fff;width:42px;height:42px}.final-cta{text-align:center;background:linear-gradient(135deg,#321374,#6d38e0);color:#fff}.final-cta h2{font-size:clamp(46px,5vw,72px);font-weight:700;line-height:1.03;letter-spacing:-.042em;margin:20px auto;max-width:1000px}.final-cta h2 i{color:#c9ff99}.final-cta>p{color:#d8cfea;font-size:17px;margin-bottom:30px}.final-cta .promo-button{background:#c9ff99;color:#26183b!important;box-shadow:none}.final-cta>div{display:flex;justify-content:center;gap:30px;margin-top:30px;font-size:12px}.final-cta>div span{display:flex;align-items:center;gap:6px}.final-cta svg{width:15px}footer{min-height:120px;background:#17131f;color:#fff;padding:35px 5vw;display:flex;align-items:center;gap:30px}footer p{color:#a99eb1;font-size:13px;margin-right:auto}footer>a:last-child{font-size:13px;font-weight:600;color:#fff}.mobile-sticky{display:none}
        ...
        @media(max-width:600px){.promo-header>.promo-logo{width:142px}.promo-logo-footer{width:145px}.hero h1{font-size:46px;line-height:1.03;letter-spacing:-.04em}.section-heading h2,.conversation h2,.boost h2,.benefit-lead h2,.custom h2,.capabilities h2,.early h2{font-size:38px;line-height:1.08;letter-spacing:-.032em}}
