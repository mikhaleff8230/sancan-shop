    ...
    <Transition appear show={isOpen} as={Fragment}>
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Overlay className="fixed inset-0 z-40 cursor-pointer bg-dark bg-opacity-60 backdrop-blur transition-opacity dark:bg-opacity-80" />
        </Transition.Child>
        <Transition.Child
          as={Fragment}
          ...
          leaveTo={leaveTo}
        >
          <div className={`fixed inset-y-0 ${positionClass} z-50 flex max-w-full`}>
            <div className="w-screen max-w-md relative z-50">
              <div className="flex h-full flex-col bg-light shadow-xl dark:bg-dark-300 relative z-50" onClick={(e) => e.stopPropagation()}>
